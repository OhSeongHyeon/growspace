...
CREATE TABLE gs_attachment_file (
...
ALTER TABLE gs_attachment_file ADD CONSTRAINT UQ_file_name UNIQUE (file_name);
ALTER TABLE gs_attachment_file ADD CONSTRAINT UQ_file_uuid UNIQUE (file_uuid);


CREATE TABLE gs_forum (
...
ALTER TABLE gs_forum ADD CONSTRAINT UQ_forum_name UNIQUE (forum_name);
ALTER TABLE gs_forum ADD CONSTRAINT UQ_forum_code UNIQUE (forum_code);


CREATE TABLE gs_forum_manager (
...
CREATE TABLE gs_forum_subscribe (
...
CREATE TABLE gs_member (
    ...
    grow_point       INT          NOT NULL DEFAULT 0 COMMENT '포인트',
...
ALTER TABLE gs_member ADD CONSTRAINT UQ_login_id UNIQUE (login_id);
ALTER TABLE gs_member ADD CONSTRAINT UQ_nick_name UNIQUE (nick_name);
ALTER TABLE gs_member ADD CONSTRAINT UQ_email UNIQUE (email);
...
ALTER TABLE gs_profile_image ADD CONSTRAINT UQ_file_name UNIQUE (file_name);
ALTER TABLE gs_profile_image ADD CONSTRAINT UQ_file_uuid UNIQUE (file_uuid);
...
ALTER TABLE gs_role ADD CONSTRAINT UQ_role_name UNIQUE (role_name);
ALTER TABLE gs_role ADD CONSTRAINT UQ_auth_lv UNIQUE (auth_lv);


CREATE TABLE gs_thread (
...
CREATE TABLE gs_thread_bookmark (
...
CREATE TABLE gs_thread_category (
...
-- FK CONSTRAINT =================================================
ALTER TABLE gs_thread ADD CONSTRAINT FK_gs_member_TO_gs_thread
FOREIGN KEY (member_id) REFERENCES gs_member (member_id) ON DELETE CASCADE;

ALTER TABLE gs_reply ADD CONSTRAINT FK_gs_member_TO_gs_reply
FOREIGN KEY (member_id) REFERENCES gs_member (member_id) ON DELETE CASCADE;

ALTER TABLE gs_reply ADD CONSTRAINT FK_gs_thread_TO_gs_reply
FOREIGN KEY (thread_id) REFERENCES gs_thread (thread_id) ON DELETE CASCADE;

ALTER TABLE gs_forum_manager ADD CONSTRAINT FK_gs_member_TO_gs_forum_manager
FOREIGN KEY (member_id) REFERENCES gs_member (member_id) ON DELETE CASCADE;

ALTER TABLE gs_member ADD CONSTRAINT FK_gs_role_TO_gs_member
FOREIGN KEY (role_id) REFERENCES gs_role (role_id) ON DELETE RESTRICT;

ALTER TABLE gs_thread ADD CONSTRAINT FK_gs_role_TO_gs_thread
FOREIGN KEY (role_id) REFERENCES gs_role (role_id) ON DELETE RESTRICT;

ALTER TABLE gs_like_thread ADD CONSTRAINT FK_gs_member_TO_gs_like_thread
FOREIGN KEY (member_id) REFERENCES gs_member (member_id) ON DELETE CASCADE;

ALTER TABLE gs_like_thread ADD CONSTRAINT FK_gs_thread_TO_gs_like_thread
FOREIGN KEY (thread_id) REFERENCES gs_thread (thread_id) ON DELETE CASCADE;

ALTER TABLE gs_attachment_file ADD CONSTRAINT FK_gs_thread_TO_gs_attachment_file
FOREIGN KEY (thread_id) REFERENCES gs_thread (thread_id) ON DELETE CASCADE;

ALTER TABLE gs_hate_thread ADD CONSTRAINT FK_gs_member_TO_gs_hate_thread
FOREIGN KEY (member_id) REFERENCES gs_member (member_id) ON DELETE CASCADE;

ALTER TABLE gs_hate_thread ADD CONSTRAINT FK_gs_thread_TO_gs_hate_thread
FOREIGN KEY (thread_id) REFERENCES gs_thread (thread_id) ON DELETE CASCADE;

ALTER TABLE gs_thread ADD CONSTRAINT FK_gs_forum_TO_gs_thread
FOREIGN KEY (forum_id) REFERENCES gs_forum (forum_id) ON DELETE CASCADE;

ALTER TABLE gs_forum_manager ADD CONSTRAINT FK_gs_forum_TO_gs_forum_manager
FOREIGN KEY (forum_id) REFERENCES gs_forum (forum_id) ON DELETE CASCADE;

ALTER TABLE gs_forum_subscribe ADD CONSTRAINT FK_gs_member_TO_gs_forum_subscribe
FOREIGN KEY (member_id) REFERENCES gs_member (member_id) ON DELETE CASCADE;

ALTER TABLE gs_forum_subscribe ADD CONSTRAINT FK_gs_forum_TO_gs_forum_subscribe
FOREIGN KEY (forum_id) REFERENCES gs_forum (forum_id) ON DELETE CASCADE;

ALTER TABLE gs_thread_bookmark ADD CONSTRAINT FK_gs_member_TO_gs_thread_bookmark
FOREIGN KEY (member_id) REFERENCES gs_member (member_id) ON DELETE CASCADE;

ALTER TABLE gs_thread_bookmark ADD CONSTRAINT FK_gs_thread_TO_gs_thread_bookmark
FOREIGN KEY (thread_id) REFERENCES gs_thread (thread_id) ON DELETE CASCADE;

ALTER TABLE gs_member ADD CONSTRAINT FK_gs_profile_image_TO_gs_member
FOREIGN KEY (profile_image_id) REFERENCES gs_profile_image (profile_image_id) ON DELETE SET NULL;

ALTER TABLE gs_reply ADD CONSTRAINT FK_gs_reply_TO_gs_reply
FOREIGN KEY (parent_id) REFERENCES gs_reply (reply_id) ON DELETE CASCADE;

ALTER TABLE gs_notification ADD CONSTRAINT FK_gs_member_TO_gs_notification
FOREIGN KEY (member_id) REFERENCES gs_member (member_id) ON DELETE CASCADE;

ALTER TABLE gs_notification ADD CONSTRAINT FK_gs_member_TO_gs_notification1
FOREIGN KEY (sender_id) REFERENCES gs_member (member_id) ON DELETE CASCADE;

ALTER TABLE gs_like_reply ADD CONSTRAINT FK_gs_reply_TO_gs_like_reply
FOREIGN KEY (reply_id) REFERENCES gs_reply (reply_id) ON DELETE CASCADE;

ALTER TABLE gs_hate_reply ADD CONSTRAINT FK_gs_reply_TO_gs_hate_reply
FOREIGN KEY (reply_id) REFERENCES gs_reply (reply_id) ON DELETE CASCADE;

ALTER TABLE gs_like_reply ADD CONSTRAINT FK_gs_member_TO_gs_like_reply
FOREIGN KEY (member_id) REFERENCES gs_member (member_id) ON DELETE CASCADE;

ALTER TABLE gs_hate_reply ADD CONSTRAINT FK_gs_member_TO_gs_hate_reply
FOREIGN KEY (member_id) REFERENCES gs_member (member_id) ON DELETE CASCADE;

ALTER TABLE gs_thread_category ADD CONSTRAINT FK_gs_forum_TO_gs_thread_category
FOREIGN KEY (forum_id) REFERENCES gs_forum (forum_id) ON DELETE CASCADE;

ALTER TABLE gs_thread ADD CONSTRAINT FK_gs_thread_category_TO_gs_thread
FOREIGN KEY (thread_category_id) REFERENCES gs_thread_category (thread_category_id) ON DELETE SET NULL;


-- UNIQUE INDEX CONSTRAINT =================================================
CREATE UNIQUE INDEX UQ_gs_forum_manager_member_id_forum_id
ON gs_forum_manager (member_id ASC, forum_id ASC);

CREATE UNIQUE INDEX UQ_gs_forum_subscribe_member_id_forum_id
ON gs_forum_subscribe (member_id ASC, forum_id ASC);

CREATE UNIQUE INDEX UQ_gs_thread_bookmark_member_id_thread_id
ON gs_thread_bookmark (member_id ASC, thread_id ASC);

CREATE UNIQUE INDEX UQ_gs_hate_thread_member_id_thread_id
ON gs_hate_thread (member_id ASC, thread_id ASC);

CREATE UNIQUE INDEX UQ_gs_like_thread_member_id_thread_id
ON gs_like_thread (member_id ASC, thread_id ASC);

CREATE UNIQUE INDEX UQ_gs_like_reply_member_id_reply_id
ON gs_like_reply (member_id ASC, reply_id ASC);

CREATE UNIQUE INDEX UQ_gs_hate_reply_member_id_reply_id
ON gs_hate_reply (member_id ASC, reply_id ASC);

CREATE UNIQUE INDEX UQ_gs_thread_category_forum_id_category_name
ON gs_thread_category (forum_id ASC, category_name ASC);


-- CHECK CONSTRAINT =================================================
ALTER TABLE gs_forum_manager
ADD CONSTRAINT CHK_gs_forum_manager_fm_role
CHECK (fm_role IN ('manager','assistant'));

ALTER TABLE gs_notification
ADD CONSTRAINT CHK_gs_notification_noti_type
CHECK (noti_type IN ('like', 'mention', 'board', 'reply', 'notice')),
ADD CONSTRAINT CHK_gs_notification_reference_type
